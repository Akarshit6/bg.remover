  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
      ...
      <div>
        ...
        <p className='my-6 text-[15px] text-grey-500'> This the discription for the project. <br className='max-sm:hidden' /> this is some extra content </p>
        <div>
          ...
          <label className='inline-flex gap-3 px-8 py-3.5 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700' 
            htmlFor="upload1">
            <img widht={20} src={assets.upload_btn_icon} alt="" />
      ...
      <div className='w-full max-w-md flex justify-center'>
        <img className='w-72 sm:w-96 lg:w-[28rem] xl:w-[32rem] 2xl:w-[36rem]' src={assets.header_img} alt="header" />
      </div>
